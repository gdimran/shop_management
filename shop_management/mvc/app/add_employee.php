                ...
                <div id="step-1">
                    ...
                    <div class="col-md-6">
                        <div class="inline-form">
                            <label class="c-label">Name</label><input class="input-style" type="text" placeholder="Name"  name="name"  />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="inline-form">
                            <label class="c-label">Email</label><input class="input-style" type="email" placeholder="Email"   name="email"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="inline-form">
                            <label class="c-label">Password</label><input type="password" placeholder="Password"  name="password"  />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="inline-form">
                            <label class="c-label">Phone Number</label><input type="text" placeholder="Phone Number"  name="phone" />
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="inline-form">
                            <label class="c-label">Address</label><input type="text" placeholder="Address"  name="address"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="inline-form">
                    ...
                    <div class="col-md-6">
                        <div class="inline-form">
                            <label class="c-label">Salary</label><input type="text" placeholder="Salary" name="salary" />
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="inline-form">
                            <select class="form-control" name="employee_roll" >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <button class="btn green-bg btn-lg" name="submit" type="submit">Add Emplyoee</button>
                        </div>
                    </div>
