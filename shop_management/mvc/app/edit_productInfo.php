...
<?php 
    ...
    $edit_obj= new ProductInfo();
    $edit_obj->prepare($_GET);
   
   $singledata=$edit_obj->show();
   $category=$edit_obj->prepare($_GET)->getCatgory();
                ...
                <h2 class="StepTitle">Product Information</h2>
                 <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Product Name</label><input class="input-style" type="text" placeholder="Product_name" name="product_name" value="<?php echo $singledata['product_name']; ?>" />
                      </div>
                 </div>
                 <div class="col-md-6">
                    <div class="inline-form">
                        
                        <select class="form-control" name="category"  value="<?php echo $singledata['product_name']; ?>" >
...
foreach ($category as $singleCategory){ ?>
                            ...
                            <option value="<?php  echo $singleCategory['category'] ?>" <?php if($singledata['category']==$singleCategory['category'])echo 'selected="selected"'; ?> ><?php  echo $singledata['category'] ?></option>
                             <?php } ?>
                       </select>
                   </div>
                </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Stock_qu</label><input  type="text" placeholder="Stock_qu" name="stock_qu" value="<?php echo $singledata['stock_qu']; ?>" />
                      </div>
                 </div>                
                <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Price</label><input  type="text" placeholder="Price" name="price" value="<?php echo $singledata['price']; ?>" />
                      </div>
                 </div>                
                <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Buy-Price</label><input  type="text" placeholder="Buy-Price" name="buy_price" value="<?php echo $singledata['buy_price']; ?>" />
                      </div>
                 </div>                
                <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Product-id</label><input  type="text" placeholder="Product-id" name="product_id" value="<?php echo $singledata['product_id']; ?>" />
                      </div>
                 </div>
