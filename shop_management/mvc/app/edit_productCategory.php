...
<div class="main-content">
    ...
    <div class="panel-content">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="javascript:void(0)" title="">Add Product (category)</a></li>
        </ul>
        <div class="main-content-area">
     
            <div id="step-1">   
                <h2 class="StepTitle">Product Category Information</h2>
                <form action="categoryUpdate.php" method="post">
              <div class="col-md-6">
                    <div class="inline-form">
                       <select class="form-control" name="category" value="<?php echo $singledata['category']; ?>" >
                            <option >category</option>
                            <option value="Sweet"  <?php if($singledata['category']=='Sweet')echo 'selected="selected"'; ?>>Sweet</option>
                            <option value="Regular Food" <?php if($singledata['category']=='Regular Food')echo 'selected="selected"'; ?>>Regular Food</option>
                            <option value="Baby Food" <?php if($singledata['category']=='Baby Food')echo 'selected="selected"'; ?>>Baby Food</option>
                            <option value="Organic Food" <?php if($singledata['category']=='Organic Food')echo 'selected="selected"'; ?>>Organic Food</option>
                            <option value="Dairy Food" <?php if($singledata['category']=='Dairy Food')echo 'selected="selected"'; ?>>Dairy Food</option>
                            <option value="Cosmetics" <?php if($singledata['category']=='Cosmetics')echo 'selected="selected"'; ?>>Cosmetics</option>
                            <option value="Toileteries" <?php if($singledata['category']=='Toileteries')echo 'selected="selected"'; ?>>Toileteries</option>
                            <option value="Home Clean" <?php if($singledata['category']=='Home Clean')echo 'selected="selected"'; ?>>Home Clean</option>
                       </select>
                   </div>
                </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Decription</label><input  type="text" placeholder="Decription" name="decription" value="<?php echo $singledata['decription']; ?>" />
                      </div>
                 </div>
                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"/>
                <div class="col-md-12">
                      <div class="form-group">
                           <button class="btn green-bg btn-lg" type="submit">Update</button>
                      </div>
                 </div>
                </form>
