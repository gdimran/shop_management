...
foreach ($userdata as $singledata){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php  echo $singledata['phone_no'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $singledata['address'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $singledata['image'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $singledata['salary'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $singledata['employee_roll'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $singledata['gender'] ?>
                                                </td>

                                                <td><a href="single_employee.php?id=<?php echo $singledata['id']; ?>">View</a></td>
                                                <td><a href="edit_employee.php?id=<?php echo $singledata['id']; ?>">Edit</a></td>
                                                <td><a href="employee_delete.php?id=<?php echo $singledata['id']; ?>">Delete</a></td>
                                            </tr>
