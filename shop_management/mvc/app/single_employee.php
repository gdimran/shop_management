                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php  echo $mydata['phone_no'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['address'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['image'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['salary'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['employee_roll'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['gender'] ?>
                                                </td>

                                                <td><a href="single-view.php?id=<?php echo $mydata['id']; ?>">View</a></td>
                                                <td><a href="edit_employee.php?id=<?php echo $mydata['id']; ?>">Edit</a></td>
                                                <td><a href="employee_delete.php?id=<?php echo $mydata['id']; ?>">Delete</a></td>
                                            </tr>
