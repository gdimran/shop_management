...
<div class="main-content">
    ...
    <div class="panel-content">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="javascript:void(0)" title="">Add customer</a></li>
        </ul>
        <div class="main-content-area">
           
            <form action="supplierUpdate.php" method="post" enctype="multipart/form-data">
            <div id="step-1">   
                <h2 class="StepTitle">Supplier Information</h2>
                 <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Name</label><input class="input-style" name="name" type="text" placeholder="Customer Name" value="<?php echo $singledata['name']; ?>" />
                      </div>
                 </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Email</label><input  type="text" name="email" placeholder="Email" value="<?php echo $singledata['email']; ?>" />
                      </div>
                 </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Phone</label><input  type="text" name="phone" placeholder="Phone" value="<?php echo $singledata['phone']; ?>" />
                      </div>
                 </div>
                <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Product Name</label><input  type="text" name="product_name" placeholder="Product Name" value="<?php echo $singledata['product_name']; ?>" />
                      </div>
                 </div>
                <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Product Quantity</label><input  type="text" name="product_qu" placeholder="Product Quantity" value="<?php echo $singledata['product_qu']; ?>" />
                      </div>
                 </div>
                <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Product Price</label><input  type="text" name="product_price" placeholder="Product Price" value="<?php echo $singledata['product_price']; ?>" />
                      </div>
                 </div>
