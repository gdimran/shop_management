                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php  echo $singledata['decription'] ?>
                                                </td>
                                                
                                                

                                                <td><a href="single_category.php?id=<?php echo $singledata['id']; ?>">View</a></td>
                                                <td><a href="edit_productCategory.php?id=<?php echo $singledata['id']; ?>">Edit</a></td>
                                                <td><a href="category_delete.php?id=<?php echo $singledata['id']; ?>">Delete</a></td>
                                            </tr>
