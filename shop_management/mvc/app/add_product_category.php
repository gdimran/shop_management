    ...
    <div class="panel-content">
        ...
        <div class="main-content-area">
            ...
            <div id="step-1">   
                ...
                <form action="categoryControll.php" method="post">
              <div class="col-md-6">
                    <div class="inline-form">
                       <select class="form-control" name="category" >
                            <option >category</option>
                            <option value="Sweet">Sweet</option>
                            <option value="Regular Food">Regular Food</option>
                 ...
                 <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Decription</label><input  type="text" placeholder="Decription" name="decription" />
                      </div>
                 </div>
                
                <div class="col-md-12">
                      <div class="form-group">
                           <button class="btn green-bg btn-lg" type="submit">Submit</button>
                      </div>
                 </div>
                </form>
