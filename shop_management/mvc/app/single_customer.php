                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php  echo $mydata['customer_name'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['contact_no'] ?>
                                                </td>
                                                <td>
                                                ...
                                                <td><a href="single_customer.php?id=<?php echo $mydata['id']; ?>">View</a></td>
                                                <td><a href="edit_customer.php?id=<?php echo $mydata['id']; ?>">Edit</a></td>
                                                <td><a href="customer_delete.php?id=<?php echo $mydata['id']; ?>">Delete</a></td>
                                            </tr>
