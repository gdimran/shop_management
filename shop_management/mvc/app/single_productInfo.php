                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php  echo $mydata['category'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['stock_qu'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['price'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['buy_price'] ?>
                                                </td>
                                                <td>
                                                    <?php  echo $mydata['product_id'] ?>
                                                </td>
                                                

                                                <td><a href="single_productInfo.php?id=<?php echo $mydata['id']; ?>">View</a></td>
                                                <td><a href="edit_productInfo.php?id=<?php echo $mydata['id']; ?>">Edit</a></td>
                                                <td><a href="productInfo_delete.php?id=<?php echo $mydata['id']; ?>">Delete</a></td>
                                            </tr>
