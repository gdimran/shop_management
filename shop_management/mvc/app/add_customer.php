...
<div class="main-content">
    ...
    <div class="panel-content">
        ...
        <div class="main-content-area">
            <form action="customerControll.php" method="post" enctype="multipart/form-data">
            <div id="step-1">   
                <h2 class="StepTitle">Account Information</h2>
                 <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Customer Name</label><input class="input-style" name="customer_name" type="text" placeholder="Customer Name" />
                      </div>
                 </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Contact Number</label><input  type="text" name="contact_no" placeholder="Contact Number" />
                      </div>
                 </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">City</label><input  type="text" name="city" placeholder="City" />
                      </div>
                 </div>
                <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Address</label><input  type="text" name="address" placeholder="Address" />
                      </div>
                 </div>
                <div class="col-md-6">
                     <div class="radio">
                       ...
                       <label>    
                         ...
                         <label>
                         <input type="radio" value="Female" id="optionsRadios1" name="gender">
                         Female
                       </label>
                    </div>
                 </div>
