...
<div class="main-content">
    ...
    <div class="panel-content">
        ...
        <div class="main-content-area">
            <form action="supplierControll.php" method="post" enctype="multipart/form-data">
            <div id="step-1">   
                <h2 class="StepTitle">Supplier Information</h2>
                 <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Name</label><input class="input-style" name="name" type="text" placeholder="Customer Name" />
                      </div>
                 </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Email</label><input  type="text" name="email" placeholder="Email" />
                      </div>
                 </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Phone</label><input  type="text" name="phone" placeholder="Phone" />
                      </div>
                 </div>
                <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Product Name</label><input  type="text" name="product_name" placeholder="Product Name" />
                      </div>
                 </div>
                <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Product Quantity</label><input  type="text" name="product_qu" placeholder="Product Quantity" />
                      </div>
                 </div>
                <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Product Price</label><input  type="text" name="product_price" placeholder="Product Price" />
                      </div>
                 </div>
