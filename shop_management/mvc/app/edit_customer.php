                ...
                <h2 class="StepTitle">Account Information</h2>
                 <div class="col-md-6">
                      <div class="inline-form">
                          <label class="c-label">Customer Name</label><input class="input-style" name="customer_name" type="text" placeholder="Customer Name" value="<?php echo $singledata['customer_name']; ?>" />
                      </div>
                 </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Contact Number</label><input  type="text" name="contact_no" placeholder="Contact Number" value="<?php echo $singledata['contact_no']; ?>"  />
                      </div>
                 </div>
                 <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">City</label><input  type="text" name="city" placeholder="City" value="<?php echo $singledata['city']; ?>" />
                      </div>
                 </div>
                <div class="col-md-6">
                      <div class="inline-form">
                           <label class="c-label">Address</label><input  type="text" name="address" placeholder="Address" value="<?php echo $singledata['address']; ?>" />
                      </div>
                 </div>
                <div class="col-md-6">
                     <div class="radio">
                         Select Gender:
                       <label>    
                         <input type="radio" value="Male" <?php echo ($singledata['gender']=='Male')?'checked':'' ?> id="optionsRadios1" name="gender">
                         Male
                       </label>
                         <label>
                         <input type="radio" value="Female" <?php echo ($singledata['gender']=='Female')?'checked':'' ?> id="optionsRadios1" name="gender">
                         Female
                       </label>
                    </div>
                 </div>
